...
// initalized Graphics library for the LCD
void InitGraphics(Graphics_Context *g_sContext_p) {
    ...
    Graphics_setFont(g_sContext_p, &g_sFontCm12);
            ...
            //Graphics_drawString(g_sContext_p, (int8_t *)"HAPPY  ****", -1, 1, 103, true);
            //Graphics_drawString(g_sContext_p, (int8_t *)"ENERGY ****", -1, 1, 115, true);
